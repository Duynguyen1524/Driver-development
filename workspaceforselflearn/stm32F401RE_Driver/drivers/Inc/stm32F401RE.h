...
// define base address of RAm and SRAM
#define FLASH_BASEADDR	0x08000000U //U denote unsigned integer FLASH the main memory
#define SRAM1_BASEADDR	0x20000000U //SRAM1 base add 112k byte
#define SRAM2_BASEADDR	0x20001C00U//SRAM2 base add 16k byte
#define ROM_BASEADDR 	0x1FFF0000u//SYSTEM MEM base add
